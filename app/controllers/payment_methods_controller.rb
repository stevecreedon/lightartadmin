  ...
  def create
    ...
    respond_to do |format|
      if @payment_method.save
        format.html { redirect_to(@payment_method, :notice => 'Payment type was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @payment_method.update_attributes(params[:payment_method])
        format.html { redirect_to(@payment_method, :notice => 'Payment type was successfully updated.') }
        format.xml  { head :ok }
      else
